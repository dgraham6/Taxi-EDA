...
<body>
  <header class="page-header" role="banner">
    ...
    <a href="https://github.com/dgraham6/Taxi-EDA" class="btn" style="background-color: #ace698; color: black;">View on GitHub</a>
    <a href="https://www.linkedin.com/in/drake-graham-a82048240/" class="btn" style="background-color: #ace698; color: black;">LinkedIn</a>
  </header>
</body>
</html>
